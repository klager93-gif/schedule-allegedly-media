# Signal Schedule v6.2.0 — Navigation & Employee Workspace

## Summary

v6.2.0 reorganizes dashboard navigation into clear sections and adds the first real Employee Workspace surface.
