# Signal Schedule v5.17.2 — Navigation & Employee Workspace

## Summary

v5.17.2 reorganizes dashboard navigation into clear sections and adds the first real Employee Workspace surface.
