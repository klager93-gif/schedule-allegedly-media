# Signal Schedule v6.1.1 — Navigation & Employee Workspace

## Summary

v6.1.1 reorganizes dashboard navigation into clear sections and adds the first real Employee Workspace surface.
