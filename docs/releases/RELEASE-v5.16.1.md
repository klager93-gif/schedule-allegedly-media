# Signal Schedule v5.16.3 — Navigation & Employee Workspace

## Summary

v5.16.3 reorganizes dashboard navigation into clear sections and adds the first real Employee Workspace surface.
