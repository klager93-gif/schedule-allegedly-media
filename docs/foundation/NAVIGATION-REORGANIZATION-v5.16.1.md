# Signal Schedule v5.17.1 — Navigation Reorganization
...
Also introduced a permission-ready grouped navigation registry in `assets/navigation.js` for future role-aware rendering.
