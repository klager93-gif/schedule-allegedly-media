# Leave Banks Foundation v5.14.2

Signal Schedule v5.14.2 adds the leave bank foundation UI and data model readiness.
...
No live database migration is required for v5.14.2.
