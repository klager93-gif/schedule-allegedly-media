...
(function () {
  ...
  window.SIGNAL_SCHEDULE_NAVIGATION = Object.freeze({
    ...
    labels: Object.freeze({
      ...
      [path('schedulingEngine','/pages/scheduling/scheduling-engine.html')]: 'Scheduling Engine',
    ...
    groups: Object.freeze([
      ...
      Object.freeze({ label: 'Operations', items: Object.freeze([item('Notifications', path('notifications','/pages/rules/notifications.html'), '🔔'), item('Scheduling Engine', path('schedulingEngine','/pages/scheduling/scheduling-engine.html'), '⚙'), item('Reports', path('reports','/pages/reports/reports.html'), '↗')]) }),
