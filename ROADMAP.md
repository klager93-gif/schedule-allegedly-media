...
- v5.19.0 — Rule Engine Foundation: conflict, coverage, qualification, approval routing, and notification trigger preview.
- v5.19.0 — Scheduling Engine: wire assignment, coverage, mandation, trades, and publishing logic.
